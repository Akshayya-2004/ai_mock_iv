...
export const generator= {
  ...
  "nodes": [
    {
      ...
      "prompt": "Greet the user and help them create a new AI Inteviewer",
      "model": {
        "model": "gpt-4o",
        "provider": "openai",
        "maxTokens": 1000,
      ...
      "variableExtractionPlan": {
        "output": [
          ...
          },
          {
            ...
            "type": "number",
            "title": "amount",
            "description": "How many questions you want me to generate for you?"
          },
          {
            "enum": [],
            "type": "string",
    ...
    {
      "name": "conversation_1748754521753",
      "type": "conversation",
      "metadata": {
        "position": {
          "x": -400,
    ...
    },
    {
      ...
      "metadata": {
        "position": {
          "x": -0.04122703567881558,
          "y": 1250.763989619671
        }
      },
      "tool": {
        "url": "https://ai-mock-iv.vercel.app/api/vapi/generate",
        "body": {
          "type": "object",
          "required": [
            "role",
    ...
    {
      "name": "conversation_1748754989213",
      "type": "conversation",
      "metadata": {
        "position": {
          "x": 7.231347869530509,
    ...
    {
      "name": "hangup_1748755085029",
      "type": "tool",
      "metadata": {
        "position": {
          "x": -601.2859387949882,
          "y": 1656.8234802289505
        }
      },
      "tool": {
        "type": "endCall"
  ...
  "edges": [
    {
      "from": "introduction",
      "to": "conversation_1748754521753",
      "condition": {
        "type": "ai",
        "prompt": "if the user provides all the required variables"
      }
    },
    {
      "from": "conversation_1748754521753",
      "to": "API Request",
      "condition": {
        "type": "ai",
        "prompt": ""
    ...
    {
      "from": "conversation_1748754989213",
      "to": "hangup_1748755085029",
      "condition": {
        "type": "ai",
        "prompt": ""
      }
